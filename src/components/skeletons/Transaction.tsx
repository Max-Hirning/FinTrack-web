...
export function TransactionSkeleton() {
  return (
    <div className="flex items-center md:w-[630px] animate-pulse">
      ...
      <article className="mr-[10px] w-[125px] max-md:hidden">
        <p className="bg-slate-200 mb-[5px]  rounded h-[16px] col-span-2"></p>
        <p className="bg-slate-200 rounded h-[15px] col-span-1"></p>
      </article>
      <p className="bg-slate-200 mr-[10px] rounded h-[16px] col-span-2 max-md:hidden w-[150px]"></p>
